...
with DAG('data_engineering_pipeline',
    ...
    download_csv = BashOperator(
        ...
        bash_command='wget -O /tmp/BTCUSDT-1s-2025-09.zip "https://data.binance.vision/data/spot/monthly/klines/BTCUSDT/1s/BTCUSDT-1s-2025-09.zip" && unzip -p /tmp/BTCUSDT-1s-2025-09.zip > /tmp/BTCUSDT-1s-2025-09.csv'
    )
